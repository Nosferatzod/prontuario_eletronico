  ...
  <div class="cadastro-container">
    ...
    <form @submit.prevent="cadastrarUsuario">
      ...
      <div class="form-group">
        ...
        <input v-model="usuario.cpf" type="text" @input="formatarCPF" maxlength="14" required>
      </div>
      ...
      <div class="botoes-container">
        ...
        <router-link to="/principal" class="botao-sair" :class="{ disabled: carregando }">Cancelar</router-link>
      </div>
    </form>
  </div>
</template>
...
export default {
  ...
  computed: {
    mostrarCampoRegistro() {
      return ['medico', 'enfermeiro', 'tecnico_enfermagem'].includes(this.usuario.ocupacao);
    },
    labelRegistro() {
      switch(this.usuario.ocupacao) {
        case 'medico': return 'CRM';
        case 'enfermeiro': return 'COREN';
        case 'tecnico_enfermagem': return 'Registro Técnico';
        default: return 'Registro';
      }
    },
    placeholderRegistro() {
      switch(this.usuario.ocupacao) {
        case 'medico': return 'Ex: 123456/SP';
        case 'enfermeiro': return 'Ex: 123456/SP';
        case 'tecnico_enfermagem': return 'Ex: 123456';
        default: return '';
      }
    }
  },
  methods: {
    ...
    async cadastrarUsuario() {
      ...
      try {
        ...
        // Validação do registro profissional quando necessário
        ...
        // Adiciona registro profissional se existir
    ...
    tratarErro(codigo) {
      switch(codigo) {
        ...
        case 'auth/weak-password':
          ...
          break;
        default:
          this.erro = typeof codigo === 'string' ? codigo : 'Erro ao cadastrar. Tente novamente.';
      }
    }
  }
};
